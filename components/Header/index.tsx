...
const Header = ({ title, visible, showMenu, onClickBurger }: HeaderProps) => {
    ...
    return (
        <>
            <div
                className={`fixed top-0 right-0 z-10 bg-theme-n-8 md:z-30 md:px-0 md:py-2 md:transition-colors ${
                    visible
            ...
            >
                <div
                    className={`flex items-center h-24 w-[70vw] mx-auto px-0 lg:px-0 md:h-16 md:px-0 md:bg-theme-on-surface-1 md:rounded-2xl md:transition-shadow ${
                        showMenu
